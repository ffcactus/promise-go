...
type InputRange struct {
	...
	MinimumVoltage     *float64 // The minimum line input voltage at which this power supply input range is effective.
	MinimumFrequencyHz *float64 // The minimum line input frequency at which this power supply input range is effective.
	MaximumFrequencyHz *float64 // The maximum line input frequency at which this power supply input range is effective.
	OutputWattage      *float64 // The maximum capacity of this Power Supply when operating in this input range.
}
...
type PowerSupply struct {
	...
	Redundancy *[]ResourceRef // This structure is used to show redundancy for power supplies.  The Component ids will reference the members of the redundancy groups.
