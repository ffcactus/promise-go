...
function ServerDetailTabSystem(props) {
  ...
  if (props.computerSystem === null) {
    ...
    content = (<div>
      <ServerDetailSectionProcessor processors={props.computerSystem.Processors} />
      <hr />
      <ServerDetailSectionMemory memory={props.computerSystem.Memory} />
      <hr />
      <ServerDetailSectionNetworkInterface networkInterfaces={props.computerSystem.NetworkInterfaces} />
      <hr />
      <ServerDetailSectionStorage storages={props.computerSystem.Storages} />
      <hr />
      <ServerDetailSectionEthernetInterface ethernetInterfaces={props.computerSystem.EthernetInterfaces} />
    </div>);
  }
  return content;
}
