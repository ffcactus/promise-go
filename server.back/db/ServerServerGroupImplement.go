...
var (
	ssgInstance ServerServerGroupImplement
)
...
func (i *ServerServerGroupImplement) GetServerServerGroupCollection(start int64, count int64, filter string) (*model.ServerServerGroupCollection, error) {
	var (
		total      int64
